...
style_img = image_loader("/home/lwl/code/python/test/neural-transfer/images/style1.jpg")
content_img = image_loader("/home/lwl/code/python/test/neural-transfer/images/input1.jpg")
...
class Normalization(nn.Module):
    def __init__(self, mean, std):
        ...
        self.mean = mean.clone().detach().view(-1, 1, 1) #deach()用来将数据稳住,不更新该部分的数据
